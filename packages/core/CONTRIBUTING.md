# Contributing to @hongkongkiwi/super-context-core

Thanks for your interest in contributing to the Super Context core package!
...
- `src/context.ts` - Main Super Context class
